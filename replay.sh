...
# Created 2021-10-15 08:25:35

CASEDIR="/global/cscratch1/sd/yazbeck/test_case_site_v3"

/global/u1/y/yazbeck/E3SM_code/cime/scripts/create_newcase -case "${CASEDIR}" -compset I1850GSWCNPECACNTBC -mach cori-knl -compiler intel -project m2467 -res 1x1_brazil

cd "${CASEDIR}"

./xmlchange -file env_run.xml -id CLM_BLDNML_OPTS -val -bgc bgc -nutrient cnp -nutrient_comp_pathway eca -soil_decomp century -nitrif_denitrif -bgc_spinup on
...
./xmlchange -file env_run.xml -id ATM_DOMAIN_FILE -val domain_sparse_grids_Theresia_1site_c211015.nc

./xmlchange -file env_run.xml -id LND_DOMAIN_FILE -val domain_sparse_grids_Theresia_1site_c211015.nc
...
./xmlchange -file env_run.xml -id STOP_N -val 37

./xmlchange -file env_workflow.xml JOB_QUEUE=debug

./xmlchange -file env_workflow.xml JOB_WALLCLOCK_TIME=00:20:00

./xmlchange -file env_run.xml -id ELM_BLDNML_OPTS -val -bgc bgc -nutrient cnp -nutrient_comp_pathway eca -soil_decomp century -bgc_spinup on
...
./xmlchange -file env_workflow.xml JOB_WALLCLOCK_TIME=00:30:00
