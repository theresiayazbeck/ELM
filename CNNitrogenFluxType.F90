...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    write(iulog,*)'7 - this%f_n2o_nit_col',this%f_n2o_nit_col
    allocate(this%f_n2o_nit_col               (begc:endc))                   ; this%f_n2o_nit_col                    (:)   = nan
    write(iulog,*)'8 - this%f_n2o_nit_col',this%f_n2o_nit_col
    ...
    dtime = real( get_step_size(), r8 )
      ...
      !end------------------------------------------------
       ...
       do fc = 1,num_soilc
          ...
          write(iulog,*)'9 - c,this%f_ngas_decomp_col(c),this%f_ngas_nitri_col(c),this%f_n2o_nit_col(c)',c,this%f_ngas_decomp_col(c),&
               this%f_ngas_nitri_col(c),this%f_n2o_nit_col(c)
