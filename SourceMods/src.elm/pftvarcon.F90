module pftvarcon
  ...
  use elm_varpar  , only:  mxpft_nc, mxpft_in, numpft_veg_c, numveg
  use elm_varctl  , only : iulog, use_vertsoilc, create_wetland_landunit
  ...
  integer :: nwetopenwater          !value for wetland open water
  integer :: nwetmud                !value for wetland mud
  integer :: nwetcattail            !value for wetland cattail
  integer :: nwetlotus              !value for wetland lotus
  integer :: nwetgrass              !value for wetland grass
...
contains
  ...
  subroutine pftconrd
    ...
    use elm_varctl,  only : use_crop, use_dynroot, use_lch4
    ...
    !
    character(len=pftname_len) :: expected_pftnames(0:mxpft_in) 
!-----------------------------------------------------------------------

    if (use_crop .and. use_lch4) THEN
       ...
       expected_pftnames(51) = 'wetland_open_water                 '
       expected_pftnames(52) = 'wetland_mud                        '
       expected_pftnames(53) = 'wetland_cattail                    '
       expected_pftnames(54) = 'wetland_lotus                      '
       expected_pftnames(55) = 'wetland_grass                      '

    elseif (use_crop .and. .not. use_lch4) THEN
    ...
    elseif (.not. use_crop .and. use_lch4) THEN
       ...
       expected_pftnames(23) = 'soybean                            '
       expected_pftnames(24) = 'irrigated_soybean                  '
       expected_pftnames(25) = 'wetland_open_water                 '
       expected_pftnames(26) = 'wetland_mud                        '
       expected_pftnames(27) = 'wetland_cattail                    '
       expected_pftnames(28) = 'wetland_lotus                      '
       expected_pftnames(29) = 'wetland_grass                      '

       elseif (.not. use_crop .and. .not. use_lch4) THEN
    ...
    allocate(character(pftname_len) :: pftname(0:mxpft_in))
    ...
    do i = 0, mxpft_in
       ...
       if ( trim(pftname(i)) == 'wetland_open_water'                  ) nwetopenwater        = i
       if ( trim(pftname(i)) == 'wetland_mud'                         ) nwetmud              = i
       if ( trim(pftname(i)) == 'wetland_cattail'                     ) nwetcattail          = i
       if ( trim(pftname(i)) == 'wetland_lotus'                       ) nwetlotus            = i
       if ( trim(pftname(i)) == 'wetland_grass'                       ) nwetgrass            = i
    ...
    if( .not. use_fates ) then
       if( .not. use_crop .and. .not. use_lch4 ) then
          if ( npcropmax /= mxpft_in )then
             call endrun(msg=' ERROR: npcropmax is NOT the last value'//errMsg(__FILE__, __LINE__))
          end if
       elseif( .not. use_crop .and. use_lch4 ) then
          if ( npcropmax /= mxpft_in-5 )then
             call endrun(msg=' ERROR: npcropmax is NOT the last value'//errMsg(__FILE__, __LINE__))
          end if
       elseif( use_crop .and. .not. use_lch4 ) then
          if ( npcropmax /= mxpft_in )then
       ...
       elseif( use_crop .and. use_lch4 ) then
          if ( nppercropmax /= mxpft-5 )then
             call endrun(msg=' ERROR: nppercropmax is NOT the last value'//errMsg(__FILE__, __LINE__))
          end if
       end if
       do i = 0, mxpft
          if(.not. use_crop .and. i > (numveg + numpft_veg_c)) EXIT ! exit the do loop
          if( .not. use_crop) then
