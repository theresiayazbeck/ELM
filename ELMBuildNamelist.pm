...
sub process_namelist_inline_logic {
  ...
  setup_logic_create_wetland_landunit($opts->{'test'}, $nl_flags, $definition, $defaults, $nl, $physv);
...
sub setup_logic_create_wetland_landunit {
  # Create wetland land unit
  my ($test_files, $nl_flags, $definition, $defaults, $nl, $physv) = @_;

  add_default($test_files, $nl_flags->{'inputdata_rootdir'}, $definition, $defaults, $nl, 'create_wetland_landunit', 'use_lch4'=>$nl_flags->{'use_lch4'});
}
