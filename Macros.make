...
ALBANY_PATH := /global/homes/m/mperego/e3sm-software/albany-trilinos/albany-install-2021-01-05
CFLAGS := -O2 -fp-model precise -std=gnu99 -O2 -debug minimal
...
CXXFLAGS := -std=c++14 -fp-model consistent -O2
CXX_LDFLAGS := -cxxlib
CXX_LINKER := FORTRAN
FC_AUTO_R8 := -r8
FFLAGS := -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -fp-model consistent -fimf-use-svml -O2 -debug minimal -qno-opt-dynamic-align -DHAVE_ERF_INTRINSICS
FFLAGS_NOOPT := -O0
